    ...
    <html>
      ...
      >
        ...
        <div
          ...
          "
        >
          Reset your Gamess-inn password.
        </div>
            ...
            <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px">
              ...
              >
                <tr>
                  ...
                  >
                    <p style="margin: 0">
                      We are sending this email because you requested a password reset. Click on this link to create a new Password
                    </p>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  >
                    <p style="margin: 0">
                      If you didn't request the password change, you can ingnore this email
                    </p>
                  </td>
                </tr>
                <!-- COPY -->
                ...
                <tr>
                  <td
                    ...
                    "
                  >
                    <p style="margin-top: 15">Cheers,<br />GAMES-INN Team</p>
                  </td>
                </tr>
              </table>
            </td>
      ...
      <script type='text/javascript'>
        function clickyClick() {
            console.log('Got hit');
            let url = 'http://translate.google.com/#en/nl/' + document.getElementById("comment").value
